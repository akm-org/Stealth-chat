    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .chat-container { flex: 1; display: flex; flex-direction: column; overflow: hidden; height: 100v%;}
            .join-form { 
            ...
            .messages {
                ...
                min-height: 0;       /* Prevent flexbox overflow bug */
            }
            .message { 
